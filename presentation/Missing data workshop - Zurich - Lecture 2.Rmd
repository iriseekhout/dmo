...
* A method to improve the main analysis results, *so not to get a fully observed data set*.
  + Unbiased estimates
...
**Plot of the iterations for generating the imputations for *Solar.R* a the first data set**
...
**Plot of the iterations for generating the imputations for *Solar.R* a the second data set**
