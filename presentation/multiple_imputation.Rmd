...
```{r}
imp_reg <- mice(airquality %>% select(Ozone, Solar.R), method = "norm.predict", printFlag = FALSE)
...
```{r}
imp_reg <- mice(airquality, method = "norm.predict", printFlag = FALSE)
xyplot(imp_reg, Ozone ~ Solar.R)
```
...
imp_sreg1 <- mice(dat, method = "norm.nob", printFlag = FALSE)
...
```{r}
imp_reg <- mice(airquality %>% select(Ozone, Solar.R), method = "norm.nob", printFlag = FALSE)
xyplot(imp_reg, Ozone ~ Solar.R)
```
...
```{r}
imp_reg <- mice(airquality, method = "norm.nob", printFlag = FALSE)
xyplot(imp_reg, Ozone ~ Solar.R)
```
...
imp_breg1 <- mice(dat, method = "norm", printFlag = FALSE)
#xyplot(imp_sreg1, X2 ~ X1)
...
```{r}
imp_breg <- mice(airquality %>% select(Ozone, Solar.R), method = "norm", printFlag = FALSE)
...
```{r}
imp_breg <- mice(airquality, method = "norm", printFlag = FALSE)
xyplot(imp_breg, Ozone ~ Solar.R)
```
...
```{r}
imp_pmm <- mice(airquality %>% select(Ozone, Solar.R), method = "pmm", printFlag = FALSE)
...
```{r}
imp_pmm <- mice(airquality, method = "pmm", printFlag = FALSE)
xyplot(imp_pmm, Ozone ~ Solar.R)
```
