...
* Defines for each variable with missing data, the predictors for the imputation. 

```{R}
imp_pmm$predictorMatrix
```
...
```{r}
imp <- mice(airquality, maxit = 20, print = F)
plot(imp)
